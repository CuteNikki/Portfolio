  ...
  return (
    <div className='relative flex flex-col items-center justify-center overflow-hidden'>
      ...
      <div className='flex min-h-screen flex-col items-center justify-center gap-10 md:flex-row'>
        <div className='flex flex-col items-center justify-center gap-4 text-balance p-4 text-center md:items-start md:text-start'>
          ...
          <div className='flex flex-row gap-2'>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                <DropdownMenuItem
                  onClick={() => {
                    navigator.clipboard.writeText('cutenikki');
                    toast({
                      variant: 'success',
                      title: 'Success!',
                ...
                <DropdownMenuItem asChild>
                  <a href='https://discord.com/users/303142922780672013'>
                    <LinkIcon />
                    Open Profile
                  </a>
                </DropdownMenuItem>
