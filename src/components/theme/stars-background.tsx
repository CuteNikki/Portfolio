...
export const StarsBackground: React.FC<StarBackgroundProps> = ({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      stars.forEach((star) => {
        ...
        ctx.fillStyle = resolvedTheme === 'dark' ? `rgba(255, 255, 255, ${star.opacity})` : `rgba(0, 0, 0, ${star.opacity})`;
        ctx.fill();
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5 }} className={cn('fixed inset-0 -z-10', className)}>
