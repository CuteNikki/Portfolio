...
export default function Home() {
  return (
    <div className='flex w-full flex-col gap-12'>
      ...
      <section className='animate-rise-in delay-1 grid gap-8 border-y border-border py-8 lg:grid-cols-2 lg:gap-16'>
