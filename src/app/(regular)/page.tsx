    ...
    <div className='flex w-full flex-col gap-12'>
      ...
      <ScrollReveal className='scroll-reveal'>
        <Tabs defaultValue='career' className='w-full'>
          <TabsList variant='line' className='w-fit justify-start gap-6 p-0'><TabsTrigger value='career' className='h-10 flex-none rounded-none px-0 text-sm font-semibold tracking-wide data-active:text-primary-text'>Career</TabsTrigger><TabsTrigger value='education' className='h-10 flex-none rounded-none px-0 text-sm font-semibold tracking-wide data-active:text-primary-text'>Education</TabsTrigger></TabsList>
