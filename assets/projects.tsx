...
export const list: Project[] = [
  {
    name: 'Codegoblins',
    description: 'A game development studio website.',
    ...
    links: [
      { href: 'https://codegoblins.com', label: 'Website', icon: <Globe /> },
      {
        href: 'https://github.com/CuteNikki/codegoblins',
        label: 'Source',
        icon: (
          <svg role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
  ...
  },
  {
    ...
    technoligies: [
      ...
      },
      {
        name: 'Discord.js',
        icon: (
          <svg fill='#5865F2' role='img' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
